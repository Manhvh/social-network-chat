...
// mix.copyDirectory('node_modules/tinymce', tinymcePath); // Don't use

// Copy Flowbite
mix.copy('node_modules/flowbite/dist/flowbite.js', 'public/' + scriptsWebPath + '/flowbite');
// Copy font-awesome css
mix.copy('node_modules/@fortawesome/fontawesome-free/css/all.css', 'public/' + stylesWebPath + '/font-awesome');
mix.copyDirectory('node_modules/@fortawesome/fontawesome-free/webfonts', 'public/' + stylesWebPath + '/webfonts');
mix.copyDirectory('node_modules/@fortawesome/fontawesome-free/webfonts', 'public/' + stylesWebPath + 'pages/webfonts');
